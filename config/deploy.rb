...
set :application, 'yotta'
set :repo_url, 'git@github.com:cherrasco/yotta-server.git'
...
set :linked_files, fetch(:linked_files, []).push('.env', 'config/database.yml', 'config/redis.yml', 'config/dev_push.pem')
